...
int store_parameter(const char *identifier, double value)
{
  ...
  if (strcmp(identifier, parameter.name[++number]) == 0) {
    ...
    parameter.el_x_offset = value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.el_y_offset = value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.el_z_offset = value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.mag_mm_unit = value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.mag_x_offset = value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.mag_y_offset = value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.mag_z_offset = value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.spec_in = value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.spec_out = value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.max_radius = value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.save_every = (int) value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.puls_time = value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.min_shrink_factor = value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.interpol_splat = (int) value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.max_loops = (int) value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.n_pot_array = (int) value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.use_mag_pa = (int) value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.enable_epot = (int) value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.trap_theta_start = value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.trap_theta_step = value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.trap_energy_start = value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.trap_energy_end = value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.trap_phi_start = value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.trap_neg_y = (int) value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.trap_y_plane = (int) value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.trap_z_plane = (int) value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.trap_max_mirrors = (int) value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.trap_mass = value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.trap_charge = value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.trap_max_step_length = value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.trap_e_para_min = value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.trap_max_tof = value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.trap_calc_order = (int) value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.trans_b_pinch = (int) value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.trans_u_pinch = (int) value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.trans_steps = (int) value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.trap_start_x = value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.trap_stop_x = value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.trap_step_x = value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.trap_start_y = value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.trap_stop_y = value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.trap_step_y = value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    ...
    parameter.residual_gas_pressure = value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.calc_order = (int) value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.dipole_value = value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.max_mirrors = (int) value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.max_tof_in_sec = value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.e_para_min = value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.max_step_length = value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.e_min_cooling = value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.enable_rel_start_angle = (int) value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.b_field_ben1 = value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.b_field_ben2 = value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.rad_calc_mode = (int) value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.rad_shift = (int) value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.antenna_temp = value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    ...
    parameter.impedance = value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.rad_atten = (int) value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.fft_on = (int) value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
    parameter.fft_resample_tstep = value;
    parameter.inited[number] = 1;
    status = 1;
  } else if (strcmp(identifier, parameter.name[++number]) == 0) {
